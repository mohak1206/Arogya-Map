...
-- ============================================================
-- Table 2: hospitals
-- Stores hospital details, location, and real-time bed availability
-- ============================================================
...
-- Stores patient emergency requests with hospital assignments
...
-- ============================================================
-- Table 4: health_data
-- Tracks daily health metrics for each user (stress, sleep, steps, etc.)
-- ============================================================
CREATE TABLE IF NOT EXISTS health_data (
    id INT AUTO_INCREMENT PRIMARY KEY,
    user_id INT NOT NULL,
    date DATE NOT NULL,
    stress_level INT DEFAULT 0,              -- 0-100 scale
    productivity_score INT DEFAULT 0,        -- 0-100 scale
...
-- ============================================================
-- SAMPLE DATA: 5 hospitals in Mumbai & Delhi
-- ============================================================
INSERT INTO hospitals (name, location, latitude, longitude, total_beds, available_beds, icu_beds, available_icu, ventilators, available_ventilators, contact) VALUES
('AIIMS Delhi',             'Ansari Nagar, New Delhi, Delhi 110029',       28.56840000,  77.20960000, 2500, 340, 200, 42, 80, 18, '011-26588500'),
('Lilavati Hospital',       'Bandra West, Mumbai, Maharashtra 400050',     19.05270000,  72.82650000, 750,  120, 80,  22, 50, 12, '022-26751000'),
('Kokilaben Hospital',      'Andheri West, Mumbai, Maharashtra 400053',    19.12730000,  72.83800000, 700,  95,  70,  18, 45, 10, '022-30999999'),
('Safdarjung Hospital',     'Ansari Nagar West, New Delhi, Delhi 110029',  28.56720000,  77.20580000, 3000, 210, 150, 30, 60,  8, '011-26165060'),
('Fortis Mulund Mumbai',    'Mulund West, Mumbai, Maharashtra 400080',     19.17260000,  72.95230000, 450,  75,  40,  14, 30,  9, '022-21822000');

-- ============================================================
-- SAMPLE DATA: 7 days of health_data for user_id=1
-- (Run after creating a user with id=1)
-- ============================================================
